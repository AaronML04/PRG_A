...
public class UtilitatsArrays {
    ...
    public static int numeroMaximo(int[] array){
        int maximo = array[0]; // Inicializamos con el primer elemento
    ...
    public static int numeroMinimo(int[] array){
        int minimo = array[0]; // Inicializamos con el primer elemento
        ...
        return minimo; // Devolvemos el máximo encontrado
